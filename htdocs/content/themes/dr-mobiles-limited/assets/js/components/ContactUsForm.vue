  ...
  <Form v-on:submit="onSubmit" v-bind:validation-schema="schema" v-slot="{ errors }">
    <div class="grid grid-cols-12 gap-y-[30px] gap-x-0 xl:gap-x-[30px]">
      <div class="col-span-12">
        <label for="name" class="block font-primary font-bold text-[16px] text-black pb-[5px]">{{
            contact_label_1
          }}</label>
      ...
      <div class="col-span-12 xl:col-span-6">
        <label for="phone" class="block font-primary font-bold text-[16px] text-black pb-[5px]">{{
            contact_label_2
          }}</label>
      ...
      <div class="col-span-12 xl:col-span-6">
        <label for="email" class="block font-primary font-bold text-[16px] text-black pb-[5px]">{{
            contact_label_3
          }}</label>
      ...
      <div class="col-span-12">
        <label for="message" class="block font-primary font-bold text-[16px] text-black pb-[5px]">{{
            contact_label_4
          }}</label>
